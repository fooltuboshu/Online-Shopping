	...
	<div class="products" style="background-color: #E6F9E6;">
        ...
        <form action="./RemoveProductSrv" method="post">
          <table border="0">
            ...
            <tr colspan="2" align="center"><td><button><a href="adminHome.jsp">Cancel</a></button>&nbsp;</td><td><input type="submit" name="submit" value="Delete Item"></td></tr>
